...
type UserDto struct {
	...
	MyNewField    string                 `protobuf:"bytes,7,opt,name=myNewField,proto3" json:"myNewField,omitempty"`
...
func (x *UserDto) GetMyNewField() string {
	if x != nil {
		return x.MyNewField
	}
	return ""
...
const file_user_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"user.proto\x12\x06models\"\xc1\x01\n" +
	"\aUserDto\x12\x0e\n" +
	...
	"\bisActive\x18\x06 \x01(\bR\bisActive\x12\x1e\n" +
	"\n" +
	"myNewField\x18\a \x01(\tR\n" +
	"myNewFieldBa\n" +
	"\n" +
	"com.modelsB\tUserProtoP\x01Z\x10im/gen/go;models\xa2\x02\x03MXX\xaa\x02\x06Models\xca\x02\x06Models\xe2\x02\x12Models\\GPBMetadata\xea\x02\x06Modelsb\x06proto3"
